        ...
        <div class="col-md-4 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                <div class="testimonial-card d-flex justify-content-center flex-column text-center  ">
                    ...
                    <center>
                    <img src="{{$userData->image ? asset($userData->image) : asset('upload/no_user_image.png')}}" alt="alan doe" class="rounded-circle img-thumbnail" width="80"
                        height="80">
                    </center>

                    <p class="testimonial-name pt-2">{{ucfirst($userData->name)}}</p>
            ...
            <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                {{--  --}}
                <h6 class=" font-weight-bold mb-0"><a href="{{route('profile.user.edit' )}}" class="btn btn-danger mb-5">Edit</a>
                </h6>
            </div>
        </div>
    </div>
...
{{-- ----------------- STATUS STRT -------------------- --}}
        ...
        <div class="col-md-8 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title mb-1">{{$userData->name}} Status</h4>
                ...
                <div class="col-12">
                    ...
                    <div class="preview-item border-bottom">
                        ...
                        <div class="preview-item-content d-sm-flex flex-grow">
                            <div class="flex-grow">
                                <h6 class="preview-subject">Your Documents </h6>
                                <p class="text-muted mb-0">You must do this....</p>
                            </div>
                            <div class="mr-5"> 
                                <button class="btn btn-danger" >Compelete your Document</button>
                            </div>
                    ...
                    <div class="preview-item border-bottom">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">ProgressBar</p>
                        </div>
                        <div class="mr-5"> 
                    ...
                    <div class="preview-item border-bottom">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">The number of applied/p>
                        </div>
                        <div class="mr-5"> 
