            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('profile.update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  name="bio" id="bio" value="" class="form-control" rows="5">{{$userInfo->bio}}</textarea>
                    </div>
                    ...
                    <div class="row mb-3 ">
                        <div class="col-sm-10 ">
                            ...
                            <img id="showImage" class="rounded-circle avatar-xl" width="100" src="{{$userInfo->image ? asset($userInfo->image) : asset('upload/no_image.jpg')}}"
                                alt="Card image cap">
                        </div>
                    </div>
                    <!-- end Show Image -->
